...
class Test2Emission2Main(ExamTestCase):
    ...
    def test_per_category(self):
        ...
        correct = ["Dana (104) - 40 kg CO2 från transport", "Alice (101) - 15 kg CO2 från transport", "Charlie (103) - 10 kg CO2 från transport", "Bob (102) - 5 kg CO2 från transport"]
    ...
    def test_per_category_missing_category(self):
        ...
        correct = ["Alice (101) - 0 kg CO2", "Bob (102) - 0 kg CO2", "Charlie (103) - 0 kg CO2", "Dana (104) - 0 kg CO2"]
        data = self.check_print_contain(self._multi_arguments)
        self.assertOrder(correct, data)
