import marvin1  # här importerar vi funktionerna
...
def main():
    ...
    while True:
        ...
        print("2. Change The Temperature Celsius → Fahrenheit")
        ...
        if val == "1":
            ...
            print(f"Alternativet {val} finns ej med i listen..!")
